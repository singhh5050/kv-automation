...
def create_database_schema(conn, force_recreate=False):
    ...
    try:
        ...
        if not force_recreate:
            ...
            audit_columns = [
                ("companies", "sector", "VARCHAR(20) CHECK (sector IN ('healthcare', 'consumer', 'enterprise', 'manufacturing'))"),
                ...
                ("financial_reports", "sector", "VARCHAR(20) CHECK (sector IN ('healthcare', 'consumer', 'enterprise', 'manufacturing'))"),
                ("financial_reports", "sector_highlight_a", "TEXT"),
                ("financial_reports", "sector_highlight_b", "TEXT"),
                ("financial_reports", "key_risks", "TEXT"),
                ("financial_reports", "personnel_updates", "TEXT"),
                ("financial_reports", "next_milestones", "TEXT"),
