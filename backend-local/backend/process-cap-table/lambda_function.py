...
def process_cap_table_xlsx_with_override(xlsx_b64: str, filename: str, company_name_override: str = None) -> Dict[str, Any]:
    try:
        ...
        # raw (still in whatever units the sheet stores – shares or % FDS)
        ...
        # same logic you already had for total size
        ...
        # (aka "pool utilization", "pool burn", "option pool filled" – pick a label)
        pool_utilization = (
        ...
        cap_table = {
            ...
            "round_data": {
                ...
                "total_pool_size": total_pool_size,       # existing
                "pool_available": options_available,      # renamed for clarity
    ...
    try:
        ...
        cur.execute(
            """INSERT INTO cap_table_rounds (company_id, round_name, valuation, amount_raised, round_date,
               total_pool_size, pool_available, pool_utilization, options_outstanding, manually_edited, edited_by, edited_at, created_at, updated_at)
