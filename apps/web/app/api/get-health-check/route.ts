...
export async function POST(request: NextRequest) {
  try {
    console.log('🔍 Get health check API route called')
    ...
    console.log(`🔍 Getting health check for company ${company_id}`)
    ...
    console.log(`📤 Invoking Lambda with get health check payload:`, payload)
    ...
    console.log(`✅ Health check retrieved for company ${company_id}`)
